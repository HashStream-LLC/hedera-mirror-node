...
public class DynamoNotificationEventConverter {
    ...
    private static java.util.stream.Stream<Map<String, AttributeValue>> fromNotificationAuditPair(NotificationEventAuditPair eventAuditPair) {
    ...
    public static List<Map<String, AttributeValue>> fromNotificationAuditPairs(java.util.stream.Stream<NotificationEventAuditPair> eventAuditPairs) {
